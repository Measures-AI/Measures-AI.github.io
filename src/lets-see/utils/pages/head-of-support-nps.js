export const slug = 'head-of-support-nps';
...
export const config = {
  ...
  "points": [
    {
      "text": "Auto-tag themes behind detractors",
      "icon": "tags"
    },
    {
      "text": "Route fixes by team, store, or product",
      "icon": "sitemap"
    },
    {
      "text": "Report ROI of fixes, not minutes",
      "icon": "chart-line"
    }
  ],
  "fields": [
  ...
  "typedSections": [
    ...
    },
    {
      ...
      "rows": [
        {
          "image": "/img/boardroom.png",
          "title": "SOC 2 Compliance",
          "text": "Data is stored in a secure, single-tenant, isolated environment."
        },
        {
          "image": "/img/boardroom.png",
          "title": "Secure Connections",
          "text": "Connections are established with secure credentials and are encrypted in transit."
        },
        {
          "image": "/img/boardroom.png",
          "title": "Data Lineage",
          "text": "We track the data from source to destination, so you can see exactly where it came from and where it went."
        }
      ],
      "mobile": false
    },
